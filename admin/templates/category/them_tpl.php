...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            DANH MỤC <small>[<?php if(isset($_GET['id'])) echo "Sửa "; else echo "Thêm mới" ?>]</small>
        </h1>
        <ol class="breadcrumb">
                    ...
                    <div class="row">
                        <div class="col-md-9">
                            ...
                            <div id="myTabContent" class="tab-content">
                                ...
                                <div role="tabpanel" class="tab-pane fade <?php if($key==0){?> active in<?php }?>" id="<?=$value['code']?>" aria-labelledby="<?=$value['code']?>">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">Sub 1<?php if(count(get_json('lang'))>1){ ?>(<?=$value['code']?>)<?php }?>:</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" placeholder="Nhập sub 1"  name="sub_1[]" value="<?php echo $row['sub_1']?>" >
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">Sub 2<?php if(count(get_json('lang'))>1){ ?>(<?=$value['code']?>)<?php }?>:</label>
                                        <div class="col-sm-8">
                                        <input type="text" class="form-control" placeholder="Nhập sub 2"  name="sub_2[]" value="<?php echo $row['sub_2']?>" >
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">Sub 3 <?php if(count(get_json('lang'))>1){ ?>(<?=$value['code']?>)<?php }?>:</label>
                                        <div class="col-sm-8">
                                        <input type="text" class="form-control" placeholder="Nhập sub 3"  name="sub_3[]" value="<?php echo $row['sub_3']?>" >
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-group m0">
                                <label>Icon</label>
                                <input type="text" placeholder="Icon" class="form-control icp-auto" name="icon" id="icon" value="<?php echo $row['icon']?>" autocomplate="off">
                            </div>
                            ...
                            <div class="form-group m0">
                                ...
                                <select class=" form-control select2" multiple name="qua_tang[]">
                                    ...
                                    <option <?php if (strlen(strstr($row['qua_tang'], ','.$value['id_code'].',')) > 0) {echo "selected";} ?> value="<?=$value['id_code']?>"><?=$value['ten']?></option>                                      
                                    <?php } ?>
                                </select>
                            </div>
                            <?php */ ?>
                           ...
                           <div class="form-group m0">
                            ...
                            <div class="form-group">
                                <a href="/admin/index.php?p=category&a=man" type="button" class="btn btn-default">
