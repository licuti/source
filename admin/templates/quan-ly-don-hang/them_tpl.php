                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-primary table-hover">
                                ...
                                <tfoot>
                                    ...
                                    <?php } ?>
                                    <?php if($value['phi_vanchuyen']>0){ ?>
                                    <tr>
                                        <th colspan="4" class="text-right">Phí ship</th>
                                        <td class="text-right"><b><?=  numberformat($value['phi_vanchuyen'])?></b></td>
                                    </tr>
                                    <?php }?>
                                    <tr>
                                        <th colspan="4" class="text-right">Tổng tiền</th>
                                        <td class="text-right"><b><?=  numberformat($value['so_tien_giam']+$value['phi_vanchuyen']+$tongtien)?></b></td>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
