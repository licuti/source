                ...
                <div class="box-body">
                     <div class="row">
                        <div class="col-md-9">
                            ...
                            <div id="myTabContent" class="tab-content">
                                ...
                                <div role="tabpanel" class="tab-pane fade <?php if($key==0){?> active in<?php }?>" id="<?=$value['code']?>" aria-labelledby="<?=$value['code']?>">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">Tiêu đề phụ (<?=$value['code']?>):</label>
                                        <div class="col-sm-5">
                                            <input type="text" class="form-control" placeholder="Tiêu đề phụ" name="ten_phu[]" value="<?= $row['ten_phu']?>" >
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-group">
                                <a href="/admin/index.php?p=noi-dung&a=man" type="button" class="btn btn-default">
