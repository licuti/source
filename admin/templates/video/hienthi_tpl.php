                        ...
                        <table class="table table-bordered table-striped table-primary table-hover">
                            ...
                            <tbody  id="data-ajax">
                                ...
                                <tr>
                                    ...
                                    <td  class="text-center">
                                        <input class="chk_box" <?php if($d->checkPermission_edit($id_module)==0){ ?>disabled<?php }?> type="checkbox" onclick="on_check(this,'#_video','hien_thi','<?=$items[$i]['id_code']?>')" <?php if($items[$i]['hien_thi'] == 1) echo 'checked="checked"'; ?>>
                                    </td>
                                    <td class="text-center">
