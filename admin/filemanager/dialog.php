            ...
            foreach ($files as $nu=>$file_array) {
                ...
                if(in_array($file_array['extension'], $config['ext_img'])){
                    ...
                    if($ftp){
                        ...
                        if($img_width < 2400 && $img_height < 2400){
                            ...
                            echo '<script language="javascript">alert("Kích thước ảnh quá lớn. Vui lòng resize lại ảnh chiều rộng và chiều cao < 2400px ! ") </script>';
                        }
