...
function showdulieu(){
	...
	global $d, $items, $loai, $loai1,$total_page, $limit, $total_records, $where_search;
	$loai1 = $d->array_category(0,'',$_GET['loaitin'],1);
	...
	if($_REQUEST['a'] == 'man'){
            ...
            if(isset($_REQUEST['id'])){
                ...
                $items = $d->o_fet("select * from #_album where id_code=".$id." and lang='".LANG."'");
                // var_dump($items);
                // die();
