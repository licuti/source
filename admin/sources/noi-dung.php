...
function luudulieu($id_module){
	...
	if($id != '')
	{
            ...
            if($d->update($data0)) {
                foreach (get_json('lang') as $key => $value) {
                    ...
                    $data['ten_phu']        =   $d->clear(addslashes($_POST['ten_phu'][$key]));
                ...
                if ($_POST['capnhat'] == 'capnhat_sua') {
                    $d->redirect("index.php?p=noi-dung&a=edit&id=".$_GET['id']."&parent=".$_GET['parent']."");
                }else{
                    $d->redirect("index.php?p=noi-dung&a=man&parent=".$_GET['parent']);
                }
	...
	else
	{
            ...
            if($id_code = $d->insert($data0)) {
                ...
                if ($_POST['capnhat'] == 'capnhat_sua') {
                    $d->redirect("index.php?p=noi-dung&a=edit&id=".$id_code."&parent=".$_GET['parent']."");
                }else{
                    $d->redirect("index.php?p=noi-dung&a=man&parent=".$_GET['parent']);
                }
            }else{
