...
This project is indexed by GitNexus as **source** (14476 symbols, 32162 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
