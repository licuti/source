...
This project is indexed by GitNexus as **source** (15191 symbols, 34281 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
