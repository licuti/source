...
This project is indexed by GitNexus as **source** (14871 symbols, 33008 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
